...
import DropdownToggle from './DropdownToggle2';
...
class Dropdown extends React.Component {
  ...
  getNextFocusedChild(current, offset) {
    ...
    let items = qsa(this.menu, '.dropdown-item:not(.disabled)');
  ...
  maybeFocusFirst() {
    ...
    let first = this.menu.querySelector('.dropdown-item:not(.disabled)');
